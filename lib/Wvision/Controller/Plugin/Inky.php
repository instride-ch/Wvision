...
namespace Wvision\Controller\Plugin;

use Pelago\Emogrifier;
use Wvision\Tool;

class Inky extends \Zend_Controller_Plugin_Abstract
{
    /**
     * shutdown.
     */
    public function dispatchLoopShutdown()
    {
        ...
        if (!Tool::isInkyResponse($this->getResponse())) {
            return;
        }

        $inky = new \Hampe\Inky\Inky();
        $body = $inky->releaseTheKraken( $this->getResponse()->getBody());
        ...
        $this->getResponse()->setBody(trim($body));
